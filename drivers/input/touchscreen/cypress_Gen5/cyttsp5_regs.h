...
/* drv_debug commands */
#define CY_DBG_HDMI_DISABLE             0
#define CY_DBG_HDMI_ENABLE              1
...
#define CY_DBG_COVER_MODE_ON            85    //0x55
#define CY_DBG_COVER_MODE_OFF           170   //0xAA
