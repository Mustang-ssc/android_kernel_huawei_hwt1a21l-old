...
static void mdss_dsi_panel_bklt_dcs(struct mdss_dsi_ctrl_pdata *ctrl, int level)
{
	...
	led_Duty[1] =(unsigned char)level;
...
/*< DTS2014042905347 zhaoyuxia 20140429 begin */
/* < DTS2014120100949 zhangming wx241012 begin */
...
/*DTS2014101301850 zhoujian 20141013 begin */
	...
	/*DTS2014090200683 songliangliang 20140902 end */
	if (pdata == NULL) {
		pr_err("%s: Invalid input data\n", __func__);
		return -EINVAL;
	}
...
/* DTS2014050808504 daiyuhong 20140508 end > */
	pr_debug("%s:-\n", __func__);
	/* DTS2014090200683 songliangliang 20140902 begin > */
...
/* < DTS2014120100949 zhangming wx241012 end */
...
static int mdss_dsi_check_panel_status(struct mdss_panel_data *pdata)
{
	...
	/* < DTS2014121507456 zhangming 20141215 begin */  	
	/*Read register error in aging stage*/
	/* < DTS2014121602180 zhangming 20141216 begin */ 
	/*correct register to be read*/
	char rdata[3] = {0}; 
	//char expect_value = 0x9C;
	char expect_value = 0x11;
	/* < DTS2014121602180 zhangming 20141216 begin */ 
	/* < DTS2014121507456 zhangming 20141215 end */  	
	int read_length = 1;
	...
	else
	{
		if (ctrl_pdata->long_read_flag)
		{
			...
			/* < DTS2014121602180 zhangming 20141216 end */ 
			/* < DTS2014121507456 zhangming 20141215 end */  	
...
/* add delaytine-before-bl flag */
	...
	//ctrl_pdata->reg_expect_value = (!rc ? tmp : 0x1c);
      	ctrl_pdata->reg_expect_value = (!rc ? tmp : 0x11);
	/* < DTS2014121602180 zhangming 20141216 end */
	/* < DTS2014121507456 zhangming 20141215 end */  	
...
/* < DTS2014101603102 shaohongyuan wx234330 begin */
   	ctrl_pdata->panel_data.panel_info.mipi.force_clk_lane_hs = (char)1;
	pr_info("parse force_clk_lane_hs : %d \n",ctrl_pdata->panel_data.panel_info.mipi.force_clk_lane_hs);
/* DTS2014101603102 shaohongyuan wx234330 end > */
